...
abstract class DoubleTapeDataStore {
    abstract suspend fun saveString(
        key: Keys,
        value: String,
    )
    ...
    abstract fun getStringOrDefault(
        key: Keys,
        defaultValue: String,
    ): Flow<String>

    abstract suspend fun <T> saveSerialize(
        key: Keys,
        value: T,
        serializer: KSerializer<T>,
    )

    abstract fun <T> getSerializeOrDefault(
        key: Keys,
        serializer: KSerializer<T>,
        defaultValue: T,
    ): Flow<T>

    abstract fun <T> getSerialize(
        key: Keys,
        serializer: KSerializer<T>,
    ): Flow<T?>
    ...
    inline fun <reified T> get(key: Keys): Flow<T?> = getSerialize(key, serializer<T>())
